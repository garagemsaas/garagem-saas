# Condições de contratação direta — Plataforma Automotiva

Minuta de referência a adequar à proposta de cada empresa. A versão anterior baseada em planos foi arquivada e não representa a oferta atual.
...
Módulo OFICINA: atendimento, clientes, veículos, ordens, orçamentos, acompanhamento público e recuperação de oportunidades. REVENDA possui somente a fundação de capacidade; estoque, CRM, propostas e vendas não estão incluídos nesta entrega.

Ver [provisionamento](../operations/provisionamento-empresa.md), [privacidade](politica-privacidade.md) e [SLA](sla.md). Os textos comerciais e jurídicos definitivos continuam dependentes da identificação das partes e revisão responsável antes de uso contratual.
