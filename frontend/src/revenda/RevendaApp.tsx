 ...
 */
const pages = { dashboard: 'Início', clientes: 'Clientes', estoque: 'Carros', leads: 'Interessados', propostas: 'Propostas', reservas: 'Reservas', vendas: 'Vendas', retornos: 'Retornos', avaliacoes: 'Avaliações', configuracoes: 'Configurações' };
